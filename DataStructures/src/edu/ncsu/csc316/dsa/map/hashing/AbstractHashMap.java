...
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
    ...
    /**
     * Puts the specified value with the specified key in the hash table.
     *
     * @param key the key
    ...
    /**
     * Gets the value to which the specified key is mapped in the hash table, or null if 
    ...
    /**
     * Removes the mapping for the specified key from the hash table if present.
     *
     * @param key the key
     * @return the v
     */
